...
AddonID = 'plugin.video.playlistLoaderM'
...
addon_data_dir = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.playlistLoaderM/data" ).decode("utf-8"), AddonID)
